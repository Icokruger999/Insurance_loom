...
if (brokerRegisterForm) {
    brokerRegisterForm.addEventListener('submit', async (e) => {
        ...
        const createCompanyCheckbox = document.getElementById('createCompanyCheckbox');
        ...
        const formData = {
            ...
            createCompanyIfNotExists: createCompanyCheckbox ? createCompanyCheckbox.checked : false,
